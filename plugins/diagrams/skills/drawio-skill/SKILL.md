...
name: drawio-skill
version: 1.14.0
description: "Create editable draw.io diagrams and exports. Use when the user explicitly wants draw.io/diagrams.net files, editable diagrams, .drawio XML, vendor-rich shapes, UML, ERD, network topology, architecture diagrams, ML model figures, swimlanes, or PNG/SVG/PDF/JPG exported from draw.io. Prefer fireworks-tech-graph for standalone styled SVG/PNG technical illustrations that do not need draw.io editability."
license: MIT
